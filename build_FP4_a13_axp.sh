...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_FP4_a13_axp_13.0.14.log
export BDEVICE="FP4"
...
source build/envsetup.sh >> /home/jenkins/build_FP4_a13_axp_13.0.14.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_FP4_a13_axp_13.0.14.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_FP4_a13_axp_13.0.14.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_FP4_a13_axp_13.0.14.log
...
if [ "1" -eq 1 ];then
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/fairphone/sm7225" >> /home/jenkins/build_FP4_a13_axp_13.0.14.log
    fi
    git status
    croot
...
if [ -f "/home/androidsource/ZIPs/axp/persistent/FP4/${FACTORYFULLNAME}.zip" ];then
    ...
    wget -q https://fairphone-android-builds.ams3.digitaloceanspaces.com/FP4/A13/${FACTORYFULLNAME}.zip -O /home/androidsource/ZIPs/axp/persistent/FP4/${FACTORYFULLNAME}.zip || (wget https://fairphone-android-builds.ams3.digitaloceanspaces.com/FP4/A13/${FACTORYFULLNAME}.zip -O /home/androidsource/ZIPs/axp/persistent/FP4/${FACTORYFULLNAME}.zip; exit 9)
fi
