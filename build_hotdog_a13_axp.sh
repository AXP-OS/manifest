...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_hotdog_axp_13.1.8.log
...
source build/envsetup.sh >> /home/jenkins/build_hotdog_axp_13.1.8.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_hotdog_axp_13.1.8.log
source /ssd2/aos/Scripts/init.sh >> /home/jenkins/build_hotdog_axp_13.1.8.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_hotdog_axp_13.1.8.log
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/oneplus/sm8150 -L /home/jenkins/build_hotdog_axp_13.1.8.log
    exit 5
}
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/oneplus/sm8150" >> /home/jenkins/build_hotdog_axp_13.1.8.log
    fi
    git status
    croot
