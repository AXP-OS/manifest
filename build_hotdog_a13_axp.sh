...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_hotdog_a13_axp_13.0.254.log
...
source build/envsetup.sh >> /home/jenkins/build_hotdog_a13_axp_13.0.254.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_hotdog_a13_axp_13.0.254.log
source /home/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_hotdog_a13_axp_13.0.254.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_hotdog_a13_axp_13.0.254.log
...
export EXTENDROM_PACKAGES="additional_repos.xml Phonesky_AXP-OS Magisk AuroraStore MicrogGmsCore_GH GsfProxy_GH noeSpeakNG NeoLauncher-latest"
