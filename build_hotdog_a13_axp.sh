...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_hotdog_axp_2025-06-05.2.log
...
source build/envsetup.sh >> /home/jenkins/build_hotdog_axp_2025-06-05.2.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_hotdog_axp_2025-06-05.2.log
source /ssd2/aos/Scripts/init.sh >> /home/jenkins/build_hotdog_axp_2025-06-05.2.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_hotdog_axp_2025-06-05.2.log

# support A14 and later

        
breakfast lineage_hotdog${brf_suffix}-user
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/oneplus/sm8150 -L /home/jenkins/build_hotdog_axp_2025-06-05.2.log
    exit 5
}
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/oneplus/sm8150" >> /home/jenkins/build_hotdog_axp_2025-06-05.2.log
    fi
    git status
    croot
    ...
    out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/hotdog/vbmeta.img 2> /dev/null \
        || (out/host/linux-x86/bin/avbtool info_image --image out/target/product/hotdog/obj/PACKAGING/target_files_intermediates/lineage_hotdog-target_files-eng.emy/IMAGES/vbmeta.img;\
            out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/hotdog/obj/PACKAGING/target_files_intermediates/lineage_hotdog-target_files-eng.emy/IMAGES/vbmeta.img)
    
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/home/androidsource/ZIPs/axp/zips/hotdog/LineageOS-20.0/release_keys/\n${ZIPINF}"
