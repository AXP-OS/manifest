...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_hotdog_a13_axp_13.0.295.log
...
source build/envsetup.sh >> /home/jenkins/build_hotdog_a13_axp_13.0.295.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_hotdog_a13_axp_13.0.295.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_hotdog_a13_axp_13.0.295.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_hotdog_a13_axp_13.0.295.log
...
if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
   ...
   echo "[GIT] committed scripted kernel changes for kernel/oneplus/sm8150" >> /home/jenkins/build_hotdog_a13_axp_13.0.295.log
fi
git status
croot
