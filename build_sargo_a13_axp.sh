...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_sargo_a13_axp_13.0.1.log
...
source build/envsetup.sh >> /home/jenkins/build_sargo_a13_axp_13.0.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_sargo_a13_axp_13.0.1.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_sargo_a13_axp_13.0.1.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_sargo_a13_axp_13.0.1.log
...
export EXTENDROM_PACKAGES="AOSmium_webview32 additional_repos.xml AuroraStore F-Droid noeSpeakNG noDefaultBrowserWebView GsfProxy_GH Magisk MicrogGmsCore_GH NeoLauncher-latest Phonesky_AXP-OS OpenEUICC_AXP-OS"
...
if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
   ...
   echo "[GIT] committed scripted kernel changes for kernel/google/msm-4.9" >> /home/jenkins/build_sargo_a13_axp_13.0.1.log
fi
git status
croot
...
VERSION="20.0-20250301-dos"
FZIP="AXP.OS-${VERSION}-sargo"
source vendor/firmware/sargo/0SOURCE
if [ -f out/sargo-factory.zip ];then rm out/sargo-factory.zip;fi
if [ -f "/ssd/axp/persistent/sargo/sargo-${FACTORYID}-factory-${FACTORYIDHASH}.zip" ];then
    echo "Using previously downloaded factory image: sargo-${FACTORYID}-factory-${FACTORYIDHASH}.zip"
    cp "/ssd/axp/persistent/sargo/sargo-${FACTORYID}-factory-${FACTORYIDHASH}.zip" out/sargo-factory.zip 
else
    echo "sargo-${FACTORYID}-factory-${FACTORYIDHASH}.zip not found in: /ssd/axp/persistent/sargo, downloading.."
...
mv ${FZIP}-factory.zip* /ssd/axp/zips/sargo/LineageOS-20.0/release_keys//target_files/
FZIPINF="\n\tand the FACTORY zip here: /ssd/axp/zips/sargo/LineageOS-20.0/release_keys//target_files/${FZIP}-factory.zip\n"
cd /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0
...
echo -e "\n\nSUCCESS:\nYou should find your build here:\n/ssd/axp/zips/sargo/LineageOS-20.0/release_keys/\n${ZIPINF}"
