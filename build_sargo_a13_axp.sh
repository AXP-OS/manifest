...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_sargo_axp_2025-06-05.1.log
...
source build/envsetup.sh >> /home/jenkins/build_sargo_axp_2025-06-05.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_sargo_axp_2025-06-05.1.log
source /ssd2/aos/Scripts/init.sh >> /home/jenkins/build_sargo_axp_2025-06-05.1.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_sargo_axp_2025-06-05.1.log
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/google/msm-4.9 -L /home/jenkins/build_sargo_axp_2025-06-05.1.log
    exit 5
}
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/google/msm-4.9" >> /home/jenkins/build_sargo_axp_2025-06-05.1.log
    fi
    git status
    croot
