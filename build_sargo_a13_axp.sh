...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_sargo_a13_axp_13.0.12.log
...
source build/envsetup.sh >> /home/jenkins/build_sargo_a13_axp_13.0.12.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_sargo_a13_axp_13.0.12.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_sargo_a13_axp_13.0.12.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_sargo_a13_axp_13.0.12.log
...
export EXTENDROM_PACKAGES="AOSmium_webview32 additional_repos.xml AuroraStore F-Droid noeSpeakNG noDefaultBrowserWebView OpenEUICC_AXP-OS"
...
if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
   ...
   echo "[GIT] committed scripted kernel changes for kernel/google/msm-4.9" >> /home/jenkins/build_sargo_a13_axp_13.0.12.log
fi
git status
croot
...
mv ${FZIP}-factory.zip* /ssd/slim/zips/sargo/LineageOS-20.0/release_keys//target_files/
FZIPINF="\n\tand the FACTORY zip here: /ssd/slim/zips/sargo/LineageOS-20.0/release_keys//target_files/${FZIP}-factory.zip\n"
cd /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0
...
echo -e "\n\nSUCCESS:\nYou should find your build here:\n/ssd/slim/zips/sargo/LineageOS-20.0/release_keys/\n${ZIPINF}"
