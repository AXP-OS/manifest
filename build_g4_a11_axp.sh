...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_h815_a11_axp_11.0.108.log
export BDEVICE="h815"
...
source build/envsetup.sh >> /home/jenkins/build_h815_a11_axp_11.0.108.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_h815_a11_axp_11.0.108.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_h815_a11_axp_11.0.108.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_h815_a11_axp_11.0.108.log
...
if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
   ...
   echo "[GIT] committed scripted kernel changes for kernel/lge/msm8992" >> /home/jenkins/build_h815_a11_axp_11.0.108.log
fi
git status
croot
