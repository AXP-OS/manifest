...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_h815_a11_axp_11.0.37.log
export BDEVICE="h815"
...
if [ ! -L "$HOME/.local/bin/rename" ];then ln -s /home/androidsource/do-not-touch/axp/Build/LineageOS-18.1/rename $HOME/.local/bin/rename; fi
alias sh=/bin/bash
alias rename="/home/androidsource/do-not-touch/axp/Build/LineageOS-18.1/rename"
cd /home/androidsource/do-not-touch/axp/Build/LineageOS-18.1
source build/envsetup.sh >> /home/jenkins/build_h815_a11_axp_11.0.37.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_h815_a11_axp_11.0.37.log
source /home/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_h815_a11_axp_11.0.37.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_h815_a11_axp_11.0.37.log

breakfast lineage_h815-user
...
export EXTENDROM_SIGNING_PATCHES=false
