...
f_detect_kerr(){
    ...
    export EXTENDROM_FDROID_REPOS="axpos.xml molly.xml nailyk.xml threema.xml futo_org.xml cromite.xml izzysoft.xml microg.xml"
    ...
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/home/androidsource/ZIPs/slim/zips/sunfish/LineageOS-20.0/release_keys/\n${ZIPINF}"
