...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_sunfish_a13_axp_13.0.138.log
...
source build/envsetup.sh >> /home/jenkins/build_sunfish_a13_axp_13.0.138.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_sunfish_a13_axp_13.0.138.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_sunfish_a13_axp_13.0.138.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_sunfish_a13_axp_13.0.138.log

breakfast lineage_sunfish-user
...
export EXTENDROM_PACKAGES="Phonesky_AXP-OS additional_repos.xml Magisk AuroraStore MicrogGmsCore_GH GsfProxy_GH noeSpeakNG NeoLauncher-latest OpenEUICC_AXP-OS"
...
cp ../../AXP.OS-$VERSION-sunfish-fastboot.zip image-sunfish-${FACTORYID}.zip
...
cd ..
zip -r ../AXP.OS-${VERSION}-sunfish-factory.zip sunfish-${FACTORYID}
cd ..
sha256sum AXP.OS-${VERSION}-sunfish-factory.zip > AXP.OS-${VERSION}-sunfish-factory.zip.sha256
mv AXP.OS-${VERSION}-sunfish-factory.zip* /ssd/axp/zips/sunfish/LineageOS-20.0/release_keys// 
cd /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0
...
echo -e "\n\nSUCCESS: You should find your build here:\n/ssd/axp/zips/sunfish/LineageOS-20.0/release_keys/\n"
