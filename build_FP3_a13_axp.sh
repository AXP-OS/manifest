...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_FP3_a13_axp_13.0.24.log
export BDEVICE="FP3"
...
source build/envsetup.sh >> /home/jenkins/build_FP3_a13_axp_13.0.24.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_FP3_a13_axp_13.0.24.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_FP3_a13_axp_13.0.24.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_FP3_a13_axp_13.0.24.log
...
if [ "1" -eq 1 ];then
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/fairphone/sdm632" >> /home/jenkins/build_FP3_a13_axp_13.0.24.log
    fi
    git status
    croot
...
VERSION="20.0-20250317-SLIM"
FZIP="AXP.OS-${VERSION}-FP3"
source vendor/firmware/FP3/0SOURCE
if [ -f out/FP3-factory.zip ];then rm out/FP3-factory.zip;fi
if [ -f "/home/androidsource/ZIPs/axp/persistent/FP3/${FACTORYFULLNAME}.zip" ];then
    echo "Using previously downloaded factory image: ${FACTORYFULLNAME}.zip"
    cp "/home/androidsource/ZIPs/axp/persistent/FP3/${FACTORYFULLNAME}.zip" out/FP3-factory.zip 
else
    echo "${FACTORYFULLNAME}.zip not found in: /home/androidsource/ZIPs/axp/persistent/FP3, downloading.."
...
export FPIMGPATH=$(dirname /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0/out/FP3-factory/*/images/)/images

# extract AXP.OS factory zip and override Fairphone images by AOS ones
unzip -o /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0/out/target/product/FP3/${FZIP}-fastboot.zip -d ${FPIMGPATH} '*.img'
...
mv -v ${FZIP}-factory.zip* /home/androidsource/ZIPs/slim/zips/FP3/LineageOS-20.0/release_keys//target_files/
FZIPINF="\n\tand the FACTORY zip here: /home/androidsource/ZIPs/slim/zips/FP3/LineageOS-20.0/release_keys//target_files/${FZIP}-factory.zip\n"
cd /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0
    ...
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/home/androidsource/ZIPs/slim/zips/FP3/LineageOS-20.0/release_keys/\n${ZIPINF}"
