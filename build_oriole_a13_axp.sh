...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_oriole_a13_axp_13.0.4.log
...
source build/envsetup.sh >> /home/jenkins/build_oriole_a13_axp_13.0.4.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_oriole_a13_axp_13.0.4.log
source /home/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_oriole_a13_axp_13.0.4.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_oriole_a13_axp_13.0.4.log

breakfast lineage_oriole-user
...
unzip /home/androidsource/do-not-touch/axp/Build/LineageOS-20.0/out/oriole-factory.zip -x "*/image-oriole-*.zip" -d factory
cd factory/oriole-${FACTORYID}
cp ../../AXP.OS-$VERSION-oriole-fastboot.zip image-oriole-${FACTORYID}.zip
...
cd ..
zip -r ../AXP.OS-${VERSION}-oriole-factory.zip oriole-${FACTORYID}
cd ..
sha256sum AXP.OS-${VERSION}-oriole-factory.zip > AXP.OS-${VERSION}-oriole-factory.zip.sha256
cd /home/androidsource/do-not-touch/axp/Build/LineageOS-20.0
...
echo -e "\n\nSUCCESS: You should find your build here:\n/ssd/axp/zips/oriole/LineageOS-20.0/release_keys/\n"
