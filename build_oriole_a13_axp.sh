...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_oriole_a13_axp_13.1.3.log
...
source build/envsetup.sh >> /home/jenkins/build_oriole_a13_axp_13.1.3.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_oriole_a13_axp_13.1.3.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_oriole_a13_axp_13.1.3.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_oriole_a13_axp_13.1.3.log
...
if [ "1" -eq 1 ];then
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/google/gs201/private/gs-google" >> /home/jenkins/build_oriole_a13_axp_13.1.3.log
    fi
    git status
    croot
