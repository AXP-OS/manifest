...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_enchilada_a13_axp_13.0.1.log
...
source build/envsetup.sh >> /home/jenkins/build_enchilada_a13_axp_13.0.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_enchilada_a13_axp_13.0.1.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_enchilada_a13_axp_13.0.1.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_enchilada_a13_axp_13.0.1.log
...
if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
   ...
   echo "[GIT] committed scripted kernel changes for kernel/oneplus/sdm845" >> /home/jenkins/build_enchilada_a13_axp_13.0.1.log
fi
git status
croot
...
echo -e "\n\nSUCCESS:\nYou should find your build here:\n/ssd/slim/zips/enchilada/LineageOS-20.0/release_keys/\n${ZIPINF}"
