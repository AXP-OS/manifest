...
export HOME="/home/droidme" && echo "home set to $HOME" >> /home/droidme/build_enchilada_axp_2025-09.1.log
export BDEVICE="enchilada"
...
gpg --list-secret-keys >> /home/droidme/build_enchilada_axp_2025-09.1.log 2>&1 || true

cd /usr/src/android/axp/Build/LineageOS-20.0
source build/envsetup.sh >> /home/droidme/build_enchilada_axp_2025-09.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/droidme/build_enchilada_axp_2025-09.1.log
source /usr/src/android/axp/Scripts/init.sh >> /home/droidme/build_enchilada_axp_2025-09.1.log 2>&1 && echo "sourcing init: success" >> /home/droidme/build_enchilada_axp_2025-09.1.log
...
source vendor/firmware/enchilada/0SOURCE  >> /home/droidme/build_enchilada_axp_2025-09.1.log 2>&1 || true
        
breakfast lineage_enchilada${brf_suffix}-user >> /home/droidme/build_enchilada_axp_2025-09.1.log 2>&1
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/oneplus/sdm845 -L /home/droidme/build_enchilada_axp_2025-09.1.log
    exit 5
}
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/oneplus/sdm845" >> /home/droidme/build_enchilada_axp_2025-09.1.log
    fi
    git status
    croot
    ...
    case a13 in
      a9|a10) source ~/.venv/python2/bin/activate ;;
        ...
        mka generate_verity_key
            buildDevice enchilada || f_detect_kerr
    ...
    echo -e "\t${FPID:32:16}"
    echo -e "\t${FPID:48:16}\n"
    out/host/linux-x86/bin/avbtool info_image --image out/target/product/enchilada/vbmeta.img 2> /dev/null || true
    out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/enchilada/vbmeta.img 2> /dev/null \
        || (out/host/linux-x86/bin/avbtool info_image --image out/target/product/enchilada/obj/PACKAGING/target_files_intermediates/lineage_enchilada-target_files*/IMAGES/vbmeta.img;\
            out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/enchilada/obj/PACKAGING/target_files_intermediates/lineage_enchilada-target_files*/IMAGES/vbmeta.img)
    
    #gpg --homedir "$DOS_SIGNING_GPG" --sign --local-user "$DOS_GPG_SIGNING_KEY" --detach-sign --armor ...
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/usr/src/android/zips/enchilada/slim/zips/enchilada/LineageOS-20.0/release_keys/\n${ZIPINF}"
