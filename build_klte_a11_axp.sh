...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_klte_a11_axp_11.0.17.log
export BDEVICE="klte"
...
source build/envsetup.sh >> /home/jenkins/build_klte_a11_axp_11.0.17.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_klte_a11_axp_11.0.17.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_klte_a11_axp_11.0.17.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_klte_a11_axp_11.0.17.log

breakfast lineage_klte-eng
...
echo -e "\t${FPID:32:16}"
echo -e "\t${FPID:48:16}\n"
out/host/linux-x86/bin/avbtool info_image --image out/target/product/klte/vbmeta.img
out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/klte/vbmeta.img \
    || (out/host/linux-x86/bin/avbtool info_image --image out/target/product/klte/obj/PACKAGING/target_files_intermediates/lineage_klte-target_files-eng.emy/IMAGES/vbmeta.img;\
        out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/klte/obj/PACKAGING/target_files_intermediates/lineage_klte-target_files-eng.emy/IMAGES/vbmeta.img)

echo -e "\n\nSUCCESS: You should find your build here:\n/ssd/axp/zips/klte/LineageOS-18.1/release_keys/\n"
