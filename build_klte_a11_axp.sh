...
export HOME="/home/droidme" && echo "home set to $HOME" >> /home/droidme/build_klte_axp_2025-08-05.1.log
export BDEVICE="klte"
...
gpg --list-secret-keys >> /home/droidme/build_klte_axp_2025-08-05.1.log 2>&1 || true

cd /usr/src/android/axp/Build/LineageOS-18.1
source build/envsetup.sh >> /home/droidme/build_klte_axp_2025-08-05.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/droidme/build_klte_axp_2025-08-05.1.log
source /usr/src/android/axp/Scripts/init.sh >> /home/droidme/build_klte_axp_2025-08-05.1.log 2>&1 && echo "sourcing init: success" >> /home/droidme/build_klte_axp_2025-08-05.1.log
...
source vendor/firmware/klte/0SOURCE || true
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/samsung/msm8974 -L /home/droidme/build_klte_axp_2025-08-05.1.log
    exit 5
}
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/samsung/msm8974" >> /home/droidme/build_klte_axp_2025-08-05.1.log
    fi
    git status
    croot
