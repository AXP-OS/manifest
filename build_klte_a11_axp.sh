...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_klte_a11_axp_11.0.26.log
export BDEVICE="klte"
...
source build/envsetup.sh >> /home/jenkins/build_klte_a11_axp_11.0.26.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_klte_a11_axp_11.0.26.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_klte_a11_axp_11.0.26.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_klte_a11_axp_11.0.26.log
