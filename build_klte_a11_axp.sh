...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_klte_a11_axp_11.0.40.log
export BDEVICE="klte"
...
source build/envsetup.sh >> /home/jenkins/build_klte_a11_axp_11.0.40.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_klte_a11_axp_11.0.40.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_klte_a11_axp_11.0.40.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_klte_a11_axp_11.0.40.log
...
export EXTENDROM_PACKAGES="AOSmium_webview32 additional_repos.xml AuroraStore F-Droid noeSpeakNG GsfProxy_GH Magisk MicrogGmsCore_GH NeoLauncher-latest Phonesky_AXP-OS"
...
if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
   ...
   echo "[GIT] committed scripted kernel changes for kernel/samsung/msm8974" >> /home/jenkins/build_klte_a11_axp_11.0.40.log
fi
git status
croot
