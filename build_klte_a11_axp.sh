...
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_klte_a11_axp_11.1.0.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_klte_a11_axp_11.1.0.log
