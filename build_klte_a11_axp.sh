...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_klte_axp_2025-06-05.2.log
export BDEVICE="klte"
...
source build/envsetup.sh >> /home/jenkins/build_klte_axp_2025-06-05.2.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_klte_axp_2025-06-05.2.log
source /ssd2/aos/Scripts/init.sh >> /home/jenkins/build_klte_axp_2025-06-05.2.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_klte_axp_2025-06-05.2.log
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/samsung/msm8974 -L /home/jenkins/build_klte_axp_2025-06-05.2.log
    exit 5
}
    ...
    export EXTENDROM_PACKAGES="AOSmium_webview32 additional_repos.xml AuroraStore F-Droid noeSpeakNG noDefaultBrowserWebView Etar_ER FossifyGallery GsfProxy_GH Magisk MicrogGmsCore_GH NeoLauncher-latest Phonesky_AXP-OS"
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/samsung/msm8974" >> /home/jenkins/build_klte_axp_2025-06-05.2.log
    fi
    git status
    croot
    ...
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/home/androidsource/ZIPs/axp/zips/klte/LineageOS-18.1/release_keys/\n${ZIPINF}"
