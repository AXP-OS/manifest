...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_j5y17lte_axp_2025-05-05.2.log
...
if [ ! -L "$HOME/.local/bin/rename" ];then ln -s /ssd2/aos/Build/LineageOS-17.1/rename $HOME/.local/bin/rename; fi
alias sh=/bin/bash
alias rename="/ssd2/aos/Build/LineageOS-17.1/rename"
cd /ssd2/aos/Build/LineageOS-17.1
source build/envsetup.sh >> /home/jenkins/build_j5y17lte_axp_2025-05-05.2.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_j5y17lte_axp_2025-05-05.2.log
source /ssd2/aos/Scripts/init.sh >> /home/jenkins/build_j5y17lte_axp_2025-05-05.2.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_j5y17lte_axp_2025-05-05.2.log
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/samsung/exynos7870 -L /home/jenkins/build_j5y17lte_axp_2025-05-05.2.log
    exit 5
}
    ...
    export EXTENDROM_PACKAGES="AOSmium_webview64 additional_repos.xml AuroraStore F-Droid noeSpeakNG noDefaultBrowserWebView Etar_ER FossifyGallery GsfProxy_GH Magisk MicrogGmsCore_GH NeoLauncher-latest Phonesky_AXP-OS opencamera_j5_latest"
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/samsung/exynos7870" >> /home/jenkins/build_j5y17lte_axp_2025-05-05.2.log
    fi
    git status
    croot
    ...
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/home/androidsource/ZIPs/axp/zips/j5y17lte/LineageOS-17.1/release_keys/\n${ZIPINF}"
