...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_j5y17lte_a10_axp_10.11.1.log
...
if [ ! -L "$HOME/.local/bin/rename" ];then ln -s /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-17.1/rename $HOME/.local/bin/rename; fi
alias sh=/bin/bash
alias rename="/ssd2/androidsource/do-not-touch/axp/Build/LineageOS-17.1/rename"
cd /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-17.1
source build/envsetup.sh >> /home/jenkins/build_j5y17lte_a10_axp_10.11.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_j5y17lte_a10_axp_10.11.1.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_j5y17lte_a10_axp_10.11.1.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_j5y17lte_a10_axp_10.11.1.log
...
if [ "1" -eq 1 ];then
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/samsung/exynos7870" >> /home/jenkins/build_j5y17lte_a10_axp_10.11.1.log
    fi
    git status
    croot
