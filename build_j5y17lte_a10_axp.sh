...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_j5y17lte_a10_axp_10.0.130.log
...
source build/envsetup.sh >> /home/jenkins/build_j5y17lte_a10_axp_10.0.130.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_j5y17lte_a10_axp_10.0.130.log
source /home/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_j5y17lte_a10_axp_10.0.130.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_j5y17lte_a10_axp_10.0.130.log
...
export EXTENDROM_PACKAGES="additional_repos.xml Phonesky_AXP-OS Magisk AuroraStore MicrogGmsCore_GH GsfProxy_GH noeSpeakNG NeoLauncher-latest opencamera_j5_latest"
