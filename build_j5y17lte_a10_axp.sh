...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_j5y17lte_a10_axp_10.0.182.log
...
source build/envsetup.sh >> /home/jenkins/build_j5y17lte_a10_axp_10.0.182.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_j5y17lte_a10_axp_10.0.182.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_j5y17lte_a10_axp_10.0.182.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_j5y17lte_a10_axp_10.0.182.log
...
if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
   ...
   echo "[GIT] committed scripted kernel changes for kernel/samsung/exynos7870" >> /home/jenkins/build_j5y17lte_a10_axp_10.0.182.log
fi
git status
croot
