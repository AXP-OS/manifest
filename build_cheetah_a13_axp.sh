...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_cheetah_a13_axp_13.0.109.log
...
source build/envsetup.sh >> /home/jenkins/build_cheetah_a13_axp_13.0.109.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_cheetah_a13_axp_13.0.109.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_cheetah_a13_axp_13.0.109.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_cheetah_a13_axp_13.0.109.log
...
export EXTENDROM_PACKAGES="Phonesky_AXP-OS_testing additional_repos.xml Magisk AuroraStore MicrogGmsCore_GH GsfProxy_GH noeSpeakNG NeoLauncher-latest OpenEUICC_AXP-OS"
