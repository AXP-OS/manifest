...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_cheetah_a13_axp_13.0.116.log
...
source build/envsetup.sh >> /home/jenkins/build_cheetah_a13_axp_13.0.116.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_cheetah_a13_axp_13.0.116.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_cheetah_a13_axp_13.0.116.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_cheetah_a13_axp_13.0.116.log
...
# containing the official Google images + AXP.OS based on vendor/firmware/cheetah/0SOURCE
VERSION="20.0-20241218-dos"
source vendor/firmware/cheetah/0SOURCE
if [ -f out/cheetah-factory.zip ];then rm out/cheetah-factory.zip;fi
wget -q https://dl.google.com/dl/android/aosp/cheetah-${FACTORYID}-factory-${FACTORYIDHASH}.zip -O out/cheetah-factory.zip || (wget https://dl.google.com/dl/android/aosp/cheetah-${FACTORYID}-factory-${FACTORYIDHASH}.zip -O out/cheetah-factory.zip ; exit 9)
...
unzip /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0/out/cheetah-factory.zip -x "*/image-cheetah-*.zip" -d factory
cd factory/cheetah-${FACTORYID}
cp ../../AXP.OS-$VERSION-cheetah-fastboot.zip image-cheetah-${FACTORYID}.zip
...
cd ..
zip -r ../AXP.OS-${VERSION}-cheetah-factory.zip cheetah-${FACTORYID}
cd ..
sha256sum AXP.OS-${VERSION}-cheetah-factory.zip > AXP.OS-${VERSION}-cheetah-factory.zip.sha256
cd /ssd2/androidsource/do-not-touch/axp/Build/LineageOS-20.0
