...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_hotdogb_a13_axp_13.0.9.log
export BDEVICE="hotdogb"
...
source build/envsetup.sh >> /home/jenkins/build_hotdogb_a13_axp_13.0.9.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_hotdogb_a13_axp_13.0.9.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_hotdogb_a13_axp_13.0.9.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_hotdogb_a13_axp_13.0.9.log

breakfast lineage_hotdogb-user
...
echo -e "\t${FPID:32:16}"
echo -e "\t${FPID:48:16}\n"
out/host/linux-x86/bin/avbtool info_image --image out/target/product/hotdogb/vbmeta.img 2> /dev/null || true
out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/hotdogb/vbmeta.img 2> /dev/null \
    || (out/host/linux-x86/bin/avbtool info_image --image out/target/product/hotdogb/obj/PACKAGING/target_files_intermediates/lineage_hotdogb-target_files-eng.emy/IMAGES/vbmeta.img;\
        out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/hotdogb/obj/PACKAGING/target_files_intermediates/lineage_hotdogb-target_files-eng.emy/IMAGES/vbmeta.img)

echo -e "\n\nSUCCESS: You should find your build here:\n/ssd/axp/zips/hotdogb/LineageOS-20.0/release_keys/\n"
