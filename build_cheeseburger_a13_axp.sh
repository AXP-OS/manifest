...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_cheeseburger_axp_2025-07-05.1.log
...
source build/envsetup.sh >> /home/jenkins/build_cheeseburger_axp_2025-07-05.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_cheeseburger_axp_2025-07-05.1.log
source /ssd2/aos/Scripts/init.sh >> /home/jenkins/build_cheeseburger_axp_2025-07-05.1.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_cheeseburger_axp_2025-07-05.1.log
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/oneplus/msm8998 -L /home/jenkins/build_cheeseburger_axp_2025-07-05.1.log
    exit 5
}
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/oneplus/msm8998" >> /home/jenkins/build_cheeseburger_axp_2025-07-05.1.log
    fi
    git status
    croot
    ...
    out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/cheeseburger/vbmeta.img 2> /dev/null \
        || (out/host/linux-x86/bin/avbtool info_image --image out/target/product/cheeseburger/obj/PACKAGING/target_files_intermediates/lineage_cheeseburger-target_files-eng.emy/IMAGES/vbmeta.img;\
            out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/cheeseburger/obj/PACKAGING/target_files_intermediates/lineage_cheeseburger-target_files-eng.emy/IMAGES/vbmeta.img)
    
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/home/androidsource/ZIPs/axp/zips/cheeseburger/LineageOS-20.0/release_keys/\n${ZIPINF}"
