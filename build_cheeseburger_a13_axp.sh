...
export HOME="/home/droidme" && echo "home set to $HOME" >> /home/droidme/build_cheeseburger_axp_2025-08-05.1.log
export BDEVICE="cheeseburger"
...
gpg --list-secret-keys >> /home/droidme/build_cheeseburger_axp_2025-08-05.1.log 2>&1 || true

cd /usr/src/android/axp/Build/LineageOS-20.0
source build/envsetup.sh >> /home/droidme/build_cheeseburger_axp_2025-08-05.1.log 2>&1 && echo "sourcing envsetup: success" >> /home/droidme/build_cheeseburger_axp_2025-08-05.1.log
source /usr/src/android/axp/Scripts/init.sh >> /home/droidme/build_cheeseburger_axp_2025-08-05.1.log 2>&1 && echo "sourcing init: success" >> /home/droidme/build_cheeseburger_axp_2025-08-05.1.log
...
source vendor/firmware/cheeseburger/0SOURCE || true
        
breakfast lineage_cheeseburger${brf_suffix}-user
...
f_detect_kerr(){
    set +e
    resetEnv
    vendor/axp/scripts/find_cve_error.sh --parse -k kernel/oneplus/msm8998 -L /home/droidme/build_cheeseburger_axp_2025-08-05.1.log
    exit 5
}
    ...
    echo "[GIT] checking kernel changes in kernel/oneplus/msm8998"
    ...
    if [ $CMT -eq 1 -o $CMTL -gt 0 ];then 
       ...
       echo "[GIT] committed scripted kernel changes for kernel/oneplus/msm8998" >> /home/droidme/build_cheeseburger_axp_2025-08-05.1.log
    fi
    git status
    croot
    ...
    resetEnv
            ...
            buildDevice cheeseburger || f_detect_kerr
    ...
    echo -e "\t${FPID:32:16}"
    echo -e "\t${FPID:48:16}\n"
    out/host/linux-x86/bin/avbtool info_image --image out/target/product/cheeseburger/vbmeta.img 2> /dev/null || true
    out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/cheeseburger/vbmeta.img 2> /dev/null \
        || (out/host/linux-x86/bin/avbtool info_image --image out/target/product/cheeseburger/obj/PACKAGING/target_files_intermediates/lineage_cheeseburger-target_files*/IMAGES/vbmeta.img;\
            out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/cheeseburger/obj/PACKAGING/target_files_intermediates/lineage_cheeseburger-target_files*/IMAGES/vbmeta.img)
    
    echo -e "\n\nSUCCESS:\nYou should find your build here:\n/usr/src/android/zips/cheeseburger/axp/zips/cheeseburger/LineageOS-20.0/release_keys/\n${ZIPINF}"
