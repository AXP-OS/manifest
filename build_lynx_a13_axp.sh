...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_lynx_a13_axp_13.0.23.log
export BDEVICE="lynx"
...
source build/envsetup.sh >> /home/jenkins/build_lynx_a13_axp_13.0.23.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_lynx_a13_axp_13.0.23.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_lynx_a13_axp_13.0.23.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_lynx_a13_axp_13.0.23.log
...
echo -e "\t${FPID:32:16}"
echo -e "\t${FPID:48:16}\n"
out/host/linux-x86/bin/avbtool info_image --image out/target/product/lynx/vbmeta.img || true
out/host/linux-x86/bin/avbtool verify_image --follow_chain_partitions --image out/target/product/lynx/vbmeta.img \
