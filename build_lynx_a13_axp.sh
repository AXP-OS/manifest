...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_lynx_a13_axp_13.0.21.log
export BDEVICE="lynx"
...
source build/envsetup.sh >> /home/jenkins/build_lynx_a13_axp_13.0.21.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_lynx_a13_axp_13.0.21.log
source /home/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_lynx_a13_axp_13.0.21.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_lynx_a13_axp_13.0.21.log
