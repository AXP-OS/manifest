...
export HOME="/home/jenkins" && echo "home set to $HOME" >> /home/jenkins/build_xz2c_a13_axp_13.0.30.log
export BDEVICE="xz2c"
...
source build/envsetup.sh >> /home/jenkins/build_xz2c_a13_axp_13.0.30.log 2>&1 && echo "sourcing envsetup: success" >> /home/jenkins/build_xz2c_a13_axp_13.0.30.log
source /ssd2/androidsource/do-not-touch/axp/Scripts/init.sh >> /home/jenkins/build_xz2c_a13_axp_13.0.30.log 2>&1 && echo "sourcing init: success" >> /home/jenkins/build_xz2c_a13_axp_13.0.30.log
